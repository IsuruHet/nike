  ...
  return (
    <footer className="bg-black py-8 px-12 ">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap text-white font-roboto">
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li
                    className="mt-3 text-base leading-normal hover:text-slate-400 cursor-pointer"
                    key={link.name}
                  >
                    <a>{link.name}</a>
                  </li>
